...
namespace Unbound
{
    public class UnbRemInterface : OptionInterface
    {
        ...
        public UnbRemInterface(setupUnboundRemix modInstance, ManualLogSource loggerSource)
        {
            ...
            UnbWingsDisabled = config.Bind("UnbWingsDisabled", false);
        ...
        public readonly Configurable<bool> UnbWingsDisabled;
        ...
        public override void Initialize()
        {
            ...
            UIArrPlayerOptions = new UIelement[]
            {
                ...
                new OpLabel(200f, 450f, "Disable Cyan Wings"),
                new OpCheckBox(UnbWingsDisabled, new Vector2(230f,420f)),

                new OpLabel(360f, 450f, "Allow Object Swallowing"),
                new OpCheckBox(UnbUnpicky, new Vector2(390f,420f)),
                ...
                new OpLabel(200f, 320f, "More Debug Logs"),
                new OpCheckBox(MoreDebugLogs, new Vector2(230f,350f))
            };
